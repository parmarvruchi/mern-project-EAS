...
const handleSave = async () => {
  try {
    await axios.put(
      `http://https://mern-project-eas.onrender.com/api/employees/${employee._id}`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    src={
      employee.profilePhoto
        ? employee.profilePhoto.startsWith("http")
          ...
          ? `http://https://mern-project-eas.onrender.com${employee.profilePhoto}`
          : employee.profilePhoto.startsWith("uploads/")
          ? `http://https://mern-project-eas.onrender.com/${employee.profilePhoto}`
          : `http://https://mern-project-eas.onrender.com/uploads/${employee.profilePhoto}`
