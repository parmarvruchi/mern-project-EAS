...
const handleSave = async () => {
  try {
    await axios.put(
      `https://://mern-project-eas.onrender.com/api/employees/${employee._id}`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    src={
      employee.profilePhoto
        ? employee.profilePhoto.startsWith("http")
          ...
          ? `https://://mern-project-eas.onrender.com${employee.profilePhoto}`
          : employee.profilePhoto.startsWith("uploads/")
          ? `https://://mern-project-eas.onrender.com/${employee.profilePhoto}`
          : `https://://mern-project-eas.onrender.com/uploads/${employee.profilePhoto}`
