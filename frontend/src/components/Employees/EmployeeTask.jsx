...
const [submissionRemarks, setSubmissionRemarks] = useState({});
  ...
  const fetchEmployee = async () => {
    try {
      const res = await axios.get(
        "http://https://mern-project-eas.onrender.com/api/employee-dashboard",
        {
          headers: {
  ...
  const fetchTasks = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/employee/tasks", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const updateStatus = async (id, status) => {
    try {
      await axios.put(
        `http://https://mern-project-eas.onrender.com/api/employee/tasks/${id}`,
        {
          status,
          remarks: remarks[id] || "",
        },
  ...
  try {
    ...
    await axios.put(
      `http://https://mern-project-eas.onrender.com/api/employee/tasks/${id}/submit`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${token}`,
