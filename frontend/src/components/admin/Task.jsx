...
const Task = () => {
  ...
  const fetchTasks = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/tasks", {
        headers: { Authorization: `Bearer ${token}` },
      });
      setTasks(res.data);
    } catch (err) {
...
const handleEmployeeSelect = (employeeId, checked) => {
  ...
  await axios.put(
    `http://https://mern-project-eas.onrender.com/api/tasks/${editTaskId}`,
    editFormData,
    {
      headers: {
  ...
  await axios.post("http://https://mern-project-eas.onrender.com/api/tasks", formData, {
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "multipart/form-data",
    },
  ...
  try {
    ...
    await axios.delete(`http://https://mern-project-eas.onrender.com/api/tasks/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  try {
    await axios.put(
      `http://https://mern-project-eas.onrender.com/api/tasks/review/${id}`,
      { status },
      {
        headers: {
          Authorization: `Bearer ${token}`,
        ...
        <div key={task._id} className="task-card">
          ...
          {task.attachment && (
            <div className="task-attachment">
              <a
                href={`http://https://mern-project-eas.onrender.com/${task.attachment}`}
                target="_blank"
                rel="noreferrer"
              >
                View Attachment
          ...
          {task.employeeSubmission && (
            <div className="task-attachment">
              <a
                href={`http://https://mern-project-eas.onrender.com/${task.employeeSubmission}`}
                target="_blank"
                rel="noreferrer"
              >
