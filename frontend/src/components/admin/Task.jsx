...
const Task = () => {
  ...
  const fetchTasks = async () => {
    try {
      const res = await axios.get("https://://mern-project-eas.onrender.com/api/tasks", {
        headers: { Authorization: `Bearer ${token}` },
      });
      setTasks(res.data);
    } catch (err) {
...
const handleEmployeeSelect = (employeeId, checked) => {
  ...
  await axios.put(
    `https://://mern-project-eas.onrender.com/api/tasks/${editTaskId}`,
    editFormData,
    {
      headers: {
  ...
  await axios.post("https://://mern-project-eas.onrender.com/api/tasks", formData, {
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "multipart/form-data",
    },
  ...
  try {
    ...
    await axios.delete(`https://://mern-project-eas.onrender.com/api/tasks/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  try {
    await axios.put(
      `https://://mern-project-eas.onrender.com/api/tasks/review/${id}`,
      { status },
      {
        headers: {
          Authorization: `Bearer ${token}`,
