...
const HRList = ({ token }) => {
  ...
  const fetchHRList = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/hr", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`http://https://mern-project-eas.onrender.com/hr/${editId}`, formData, {
          headers: { Authorization: `Bearer ${token}` },
        });
        setEditId(null);
      } else {
        await axios.post("http://https://mern-project-eas.onrender.com/hr", formData, {
          headers: { Authorization: `Bearer ${token}` },
        });
      }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`http://https://mern-project-eas.onrender.com/hr/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchHRList();
    } catch (err) {
