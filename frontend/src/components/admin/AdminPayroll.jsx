...
await axios.post("http://https://mern-project-eas.onrender.com/api/hr/payroll", payrollData, {
  headers: {
...
setShowPayslip(false);
  ...
  const checkExistingPayroll = async (employeeId, month, year) => {
    try {
      ...
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/hr/payroll/check", {
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://https://mern-project-eas.onrender.com/api/hr/payroll/preview",
        {
          employeeId: formData.employeeId,
          month: formData.month,
          year: formData.year,
