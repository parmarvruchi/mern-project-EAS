...
const EngagementManagement = () => {
  ...
  const fetchSurveys = async () => {
    try {
      const res = await axios.get(
        "http://https://mern-project-eas.onrender.com/api/engagement/surveys",
        authHeader,
      );
      setSurveys(res.data || []);
    } catch (err) {
  ...
  const fetchSummary = async () => {
    try {
      const res = await axios.get(
        "http://https://mern-project-eas.onrender.com/api/engagement/summary",
        authHeader,
      );
      setSummary(res.data);
    } catch (err) {
  ...
  try {
    const res = await axios.get(
      `http://https://mern-project-eas.onrender.com/api/engagement/responses/${surveyId}`,
      authHeader
    );
  ...
  const closeSurvey = async (id) => {
    try {
      const res = await axios.put(
        `http://https://mern-project-eas.onrender.com/api/engagement/surveys/${id}/close`,
        {},
        authHeader,
      );
  ...
  const deleteSurvey = async (id) => {
    try {
      const res = await axios.delete(
        `http://https://mern-project-eas.onrender.com/api/engagement/surveys/${id}`,
        authHeader,
      );
      setMessage(res.data.message);
