...
const Report = () => {
  ...
  const handleDepartmentChange = async (e) => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://mern-project-eas.onrender.com/api/employees/by-department/${selectedDepartment}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const endpoint =
        role === "hr"
          ? "https://mern-project-eas.onrender.com/api/reports/generate-and-save"
          : "https://mern-project-eas.onrender.com/api/reports/generate";
