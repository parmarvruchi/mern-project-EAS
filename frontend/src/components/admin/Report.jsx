...
const Report = () => {
  ...
  const handleDepartmentChange = async (e) => {
    ...
    try {
      ...
      const res = await axios.get(
        `http://https://mern-project-eas.onrender.com/api/employees/by-department/${selectedDepartment}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      const endpoint =
        role === "hr"
          ? "http://https://mern-project-eas.onrender.com/api/reports/generate-and-save"
          : "http://https://mern-project-eas.onrender.com/api/reports/generate";
