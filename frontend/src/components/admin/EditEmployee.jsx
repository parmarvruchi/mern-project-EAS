...
const [filteredDesignations, setFilteredDesignations] = useState([]);
 ...
 useEffect(() => {
  axios
    .get(`http://https://mern-project-eas.onrender.com/api/employees/${id}`, {
  ...
  useEffect(() => {
  axios
    .get("http://https://mern-project-eas.onrender.com/api/departments", {
      headers: { Authorization: `Bearer ${token}` }
    })
...
useEffect(() => {
  axios
    .get("http://https://mern-project-eas.onrender.com/api/designations", {
      headers: { Authorization: `Bearer ${token}` }
    })
