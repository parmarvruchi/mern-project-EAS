...
const [filteredDesignations, setFilteredDesignations] = useState([]);
 ...
 useEffect(() => {
  axios
    .get(`https://mern-project-eas.onrender.com/api/employees/${id}`, {
  ...
  useEffect(() => {
  axios
    .get("https://mern-project-eas.onrender.com/api/departments", {
      headers: { Authorization: `Bearer ${token}` }
    })
...
useEffect(() => {
  axios
    .get("https://mern-project-eas.onrender.com/api/designations", {
      headers: { Authorization: `Bearer ${token}` }
    })
...
useEffect(() => {
  ...
  try {
    ...
    const res = await axios.put(
      `https://mern-project-eas.onrender.com/api/employees/${id}`,
      data,
      {
        headers: {
