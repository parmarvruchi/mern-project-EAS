...
const CreateJob = () => {
  ...
  const fetchJobTitlesByDepartment = async (departmentId) => {
    try {
      ...
      const res = await axios.get(
        `http://https://mern-project-eas.onrender.com/api/job-titles/by-department/${departmentId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("http://https://mern-project-eas.onrender.com/api/hr/jobs", payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
