...
const [form, setForm] = useState({
  ...
  const fetchPerformance = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/performance", {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://https://mern-project-eas.onrender.com/api/performance/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchPerformance();
    } catch (error) {
  ...
  const fetchEmployees = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/employees", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://https://mern-project-eas.onrender.com/api/performance", form, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchTopPerformers = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/performance/top", {
        headers: { Authorization: `Bearer ${token}` }
      });
      setData(res.data);
      setViewType("top");
  ...
  const fetchLowPerformers = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/performance/low", {
        headers: { Authorization: `Bearer ${token}` }
      });
      setData(res.data);
      setViewType("low");
  ...
  const fetchDepartmentReport = async () => {
    try {
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/performance/department", {
        headers: { Authorization: `Bearer ${token}` }
      });
      setData(res.data);
...
const getMonthName = (monthNumber) => {
  ...
  try {
    const res = await axios.put(
      `http://https://mern-project-eas.onrender.com/api/performance/finalize/${id}`,
      {},
      {
        headers: { Authorization: `Bearer ${token}` }
      }
