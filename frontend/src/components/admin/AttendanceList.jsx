...
const handleUpdateAttendance = async () => {
  try {
    await axios.put(
      `https://://mern-project-eas.onrender.com/api/admin/attendance/${selectedAttendance._id}`,
      editForm,
      config
    );
...
const filteredAttendance = attendance.filter((item) => {
  ...
  try {
    await axios.delete(`https://://mern-project-eas.onrender.com/api/admin/attendance/${id}`, config);
    fetchAttendance();
  } catch (err) {
