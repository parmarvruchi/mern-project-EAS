...
const fetchAttendance = async () => {
  try {
    const res = await axios.get(
      "http://https://mern-project-eas.onrender.com/api/admin/attendance",
      config
    );
...
const handleUpdateAttendance = async () => {
  try {
    await axios.put(
      `http://https://mern-project-eas.onrender.com/api/admin/attendance/${selectedAttendance._id}`,
      editForm,
      config
    );
...
const filteredAttendance = attendance.filter((item) => {
  ...
  try {
    await axios.delete(`http://https://mern-project-eas.onrender.com/api/admin/attendance/${id}`, config);
    fetchAttendance();
  } catch (err) {
