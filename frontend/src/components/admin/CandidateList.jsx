...
const CandidateList = () => {
  ...
  const fetchCandidates = async () => {
    try {
      ...
      const res = await axios.get("http://https://mern-project-eas.onrender.com/api/hr/candidates", {
  ...
  const updateStatus = async (id, status) => {
    try {
      ...
      const res = await axios.put(
        `http://https://mern-project-eas.onrender.com/api/hr/candidates/${id}/status`,
        { status },
        { headers: { Authorization: `Bearer ${token}` } },
      );
                  ...
                  <td>
                    {candidate.resume ? (
                      <div className="recruitment-actions">
                        <a
                          href={`http://https://mern-project-eas.onrender.com/api/download-resume/${candidate.resume.split("/").pop()}`}
