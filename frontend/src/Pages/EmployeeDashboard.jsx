...
const EmployeeDashboard = () => {
  ...
  const fetchEmployeeDashboard = async () => {
    try {
      const res = await axios.get("https://mern-project-eas.onrender.com/api/employee-dashboard", {
  ...
  const fetchLeaves = async () => {
    try {
      const res = await axios.get("https://mern-project-eas.onrender.com/api/leave/my-leaves", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get("https://mern-project-eas.onrender.com/api/notifications/employee", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleNotificationClick = async (e) => {
    ...
    if (isOpening) {
      try {
        await axios.put(
          "https://mern-project-eas.onrender.com/api/notifications/read-all/employee",
          {},
          {
            headers: { Authorization: `Bearer ${token}` },
          }
